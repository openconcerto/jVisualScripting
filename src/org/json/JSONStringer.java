...
public class JSONStringer {
     ...
     *        or null. May not be {@link Double#isNaN() NaNs} or {@link Double#isInfinite()
     *        infinities}.
     * @return this stringer.
     * @throws JSONException
     */
    ...
    private void string(String value) {
        ...
        for (int i = 0, length = value.length(); i < length; i++) {
            ...
            /*
             * From RFC 4627, "All Unicode characters may be placed within the quotation marks
             * except for the characters that must be escaped: quotation mark, reverse solidus, and
